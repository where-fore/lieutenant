...
func _init() -> void:
	...
	starting_stats[Stats.agility] = BalanceData.enemy_mythic_stat_budget * 3
	starting_stats[Stats.fortitude] = BalanceData.enemy_mythic_health_stat_budget * 1 / 2
