...
var my_attack:int = 20
var my_attack_multiplier:int = 100
...
func apply_my_aura() -> void:
	...
	buff_aura.additive_stat_dictionary[Stats.attack] = my_attack
	buff_aura.multiplicative_stat_dictionary[Stats.attack] = my_attack_multiplier
