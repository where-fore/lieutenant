...
func setup_item_stats() -> void:
	...
	extra_tooltip = "Pressure your enemies' flank,\nbolstering your allies {stat} by {amount}.".format({"amount": stat_to_add_to_allies, "stat": stat_to_allies}) # "Generic flavourful description"
	reward_categories = {
